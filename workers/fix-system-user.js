// Create system user with correct schema
...
async function createSystemUser() {
  console.log('🔧 Creating system user with correct schema...\n');

  try {
    // 1. Create system user with correct columns
    console.log('1️⃣ Creating system user...');
    await executeSql(`
      INSERT OR IGNORE INTO users (
        id, phone, password_suffix, name, email, role, is_active, created_at
      ) VALUES (
        'system', 
        '0000000000', 
        '000', 
    ...
    console.log('Users in database:', JSON.stringify(result.result[0].results, null, 2));
